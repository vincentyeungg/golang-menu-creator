...
type Querier interface {
	...
	GetAllActiveIngredientsFromFood(ctx context.Context, arg GetAllActiveIngredientsFromFoodParams) ([]GetAllActiveIngredientsFromFoodRow, error)
	...
	GetMenuItemIngredient(ctx context.Context, id int32) (MenuItemIngredient, error)
	GetMenuMenuItem(ctx context.Context, id int32) (MenuMenuItem, error)
